...
export const resources = {
    ...
    hi: {
        translation: {
            ...
            settings: { title: "सेटिंग्स", searchSettings: "सेटिंग्स खोजें", accessibilityDisplayLanguages: "पहुंच, प्रदर्शन और भाषाएँ", colorTheme: "रंग थीम", lightsOut: "(लाइट्स आउट)", defaultTheme: "(डिफ़ॉल्ट)", language: "भाषा", languageDescription: "Twitter आपको कौन सी भाषा दिखाए, इसे प्रबंधित करें।", premium: "प्रीमियम", currentPlan: "वर्तमान योजना:", free: "मुफ़्त", bronze: "ब्रॉन्ज", silver: "सिल्वर", gold: "गोल्ड", securityAccountAccess: "सुरक्षा और खाते की पहुंच", loginHistory: "लॉगिन इतिहास", loginHistorySubtitle: "अपने हाल के खाते की गतिविधि देखें", loginHistoryDescription: "आप कहाँ लॉग इन हैं। अपने खाते से जुड़े सभी डिवाइस और स्थान देखें।", preferredLanguage: "पसंदीदा भाषा", otpTitle: "भाषा बदलाव सत्यापित करें", otpSent: "6 अंकों का OTP आपके पंजीकृत {{method}} पर भेजा गया: {{destination}}.", simulatedOtp: "सिम्युलेटेड OTP: {{otp}}", otpPlaceholder: "OTP दर्ज करें", changed: "भाषा सफलतापूर्वक अपडेट हुई.", requestFailed: "भाषा सत्यापन शुरू नहीं हो सका.", verifyFailed: "OTP सत्यापन विफल हुआ.", alreadySelected: "यह भाषा पहले से चुनी गई है.", resendSuccess: "नया प्रमाणिकरण कोड भेजा गया है." },
    ...
    zh: {
        translation: {
            ...
            settings: { title: "设置", searchSettings: "搜索设置", accessibilityDisplayLanguages: "辅助功能、显示和语言", colorTheme: "颜色主题", lightsOut: "（熄灯）", defaultTheme: "（默认）", language: "语言", languageDescription: "管理 Twitter 向你显示的语言。", premium: "高级版", currentPlan: "当前方案：", free: "免费", bronze: "青铜", silver: "白银", gold: "黄金", securityAccountAccess: "安全和账户访问", loginHistory: "登录历史", loginHistorySubtitle: "查看你最近的账户活动", loginHistoryDescription: "你登录的位置。查看与你的账号相关联的所有设备和地点。", preferredLanguage: "首选语言", otpTitle: "验证语言更改", otpSent: "6 位 OTP 已发送到你注册的 {{method}}：{{destination}}。", simulatedOtp: "模拟 OTP：{{otp}}", otpPlaceholder: "输入 OTP", changed: "语言已成功更新。", requestFailed: "无法开始语言验证。", verifyFailed: "OTP 验证失败。", alreadySelected: "已选择此语言。", resendSuccess: "已发送新的验证码。" },
